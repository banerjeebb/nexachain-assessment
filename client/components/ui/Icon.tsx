...
const paths: Record<string, React.ReactNode> = {
  ...
  investments: <><rect x="2" y="3" width="20" height="14" rx="2" /><line x1="8" y1="21" x2="16" y2="21" /><line x1="12" y1="17" x2="12" y2="21" /></>,
  referrals: <><circle cx="17" cy="5" r="3" /><circle cx="7" cy="12" r="3" /><circle cx="17" cy="19" r="3" /><line x1="14.18" y1="6.64" x2="9.82" y2="10.36" /><line x1="14.18" y1="17.36" x2="9.82" y2="13.64" /></>,
  wallet: <><path d="M21 12V7H5a2 2 0 010-4h14v4" /><path d="M3 5v14a2 2 0 002 2h16v-5" /><path d="M18 12a2 2 0 000 4h4v-4z" /></>,
  history: <><circle cx="12" cy="12" r="10" /><polyline points="12 6 12 12 16 14" /></>,
  tree: <><path d="M12 3v18M3 9h18M3 15h18" /></>,
  ...
  roi: <><polyline points="22 12 18 12 15 21 9 3 6 12 2 12" /></>,
  ...
  withdraw: <><path d="M12 2v20M17 7H9.5a3.5 3.5 0 000 7H12" /><polyline points="7 17 2 12 7 7" /></>,
}
